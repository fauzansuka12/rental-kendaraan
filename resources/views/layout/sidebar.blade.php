...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>RENTAL CAR</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <span>{{auth()->user()->role7}}</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="{{route('home')}}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{route('transaksi')}}" class="nav-item nav-link"><i class="fa fa-hand-holding-usd me-2"></i>Transaksi</a>
                    <a href="{{route('laporan')}}" class="nav-item nav-link"><i class="fa fa-book me-2"></i>Laporan</a>
