                ...
                <div class="col-12 col-sm-8 col-md-8 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h2 class="text-primary fw-bold text-uppercase shadow-sm" style="letter-spacing: 1px; text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2) ">
                                Register
                            </h2>
                        </div>
                        ...
                        @enderror
                            ...
                            <p class="text-center mb-0">Apakah Kamu Sudah Punya Akun <a href="{{ route('login') }}">Login</a></p>                            
                            </form>
                    </div>
                </div>
            </div>
